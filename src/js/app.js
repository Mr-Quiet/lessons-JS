...
// Функционал добавления классов к боковым меню при прокрутке
// flsScroll.asideScroll();

// Функционал липкого блока
// flsScroll.stickyBlock();

// Паралакс заднего фона при скроле
// Для работы добавить к блоку data-parallax-bg
// и подключить стили в "./files/scroll/scroll.js"
// alt + click to bgParallax()
...
/* Календарь */
// Документация: https://www.npmjs.com/package/js-datepicker
// import './libs/datepicker-full.min';
